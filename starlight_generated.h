...
#ifndef FLATBUFFERS_GENERATED_STARLIGHT_H_
#define FLATBUFFERS_GENERATED_STARLIGHT_H_
...
inline const Chunk *GetChunk(const void *buf) { return flatbuffers::GetRoot<Chunk>(buf); }

inline bool VerifyChunkBuffer(flatbuffers::Verifier &verifier) { return verifier.VerifyBuffer<Chunk>(); }

inline void FinishChunkBuffer(flatbuffers::FlatBufferBuilder &fbb, flatbuffers::Offset<Chunk> root) { fbb.Finish(root); }


#endif  // FLATBUFFERS_GENERATED_STARLIGHT_H_
